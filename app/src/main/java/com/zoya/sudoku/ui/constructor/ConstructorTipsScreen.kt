...
private val tips = listOf(
    ...
    "Не знаете, с чего начать? Возьмите за образец классические квадраты 3×3 и слегка измените их края — так почти всегда получается рабочая раскладка."
)
...
fun ConstructorTipsScreen(onHome: () -> Unit) {
    Surface(modifier = Modifier.fillMaxSize(), color = MaterialTheme.colorScheme.background) {
        Column(
            ...
            ScreenHeader("Как сделать раскладку", onHome)
